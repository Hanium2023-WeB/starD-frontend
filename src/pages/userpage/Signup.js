...
const Signup = () => {
        ...
        const fileInputRef = useRef(null); // 파일 input을 참조하는 ref 생성
        ...
        const onchangeImageDelete = (e) => {
            ...
            if (fileInputRef.current) {
                fileInputRef.current.value = "";    // input 값 초기화 (파일명 삭제)
            }
            setImageSrc("");
        }
        ...
        const handleCheckDuplicateID = () => {
            ...
            axios
                ...
                .then((response) => {
                    ...
                    if (message) {
                        message.textContent = !isDuplicate ? "이미 존재하는 이메일입니다."
                            : "사용 가능한 이메일입니다.";
                ...
                <div className="containers" id="sign">
                    ...
                    <form onSubmit={handleSubmit}>
                            ...
                            <div className={"profile_wrapper"}>
                                ...
                                <div className={"profile_content"}>
                                    ...
                                    <input className="image-upload" type="file" accept="image/*"
                                           ref={fileInputRef} onChange={onchangeImageUpload}/>
                                    <button className="image-delete"
                                            onClick={onchangeImageDelete}>삭제
                                    </button>
                                </div>
                            </div>
                            <div style={{position: "relative"}}>
                                <div className="input_info" style={{left: "31px"}}>
                                    <div className="subinfo">이메일<span
                                        className="require_info">*</span></div>
                                    <div className="signup_id input_bottom">
                                        <div style={{display: "flex", alignItems: "center"}}>
                                            ...
                                            />
                                            <button id="signup_nicname_btn" type="button"
                                        ...
                                        {state.email !== "" ? (
                                            state.isValidEmail ? (
                                                <p className="is_valid_email"
                                                   style={{color: "blue"}}>유효한 email입니다.</p>
                                            ) : (
                                                <p className="is_valid_email"
                                                   style={{color: "red"}}>유효하지 않은 email입니다.</p>
                                            )
                                        ) : null}
                                    </div>
                                    ...
                                    <div className="subinfo">비밀번호<span
                                        className="require_info">*</span></div>
                                    <div className="inputpw input_bottom">
                                        ...
                                        {state.password !== "" ? (
                                            state.isValidPassword ? (
                                                ...
                                                <p style={{color: "red"}}>비밀번호는 8 ~ 15자 영문, 숫자, 특수문자
                                                    조합이어야 합니다.</p>
                                            )
                                        ) : null}
                                    </div>

                                    <div className="subinfo">비밀번호 확인<span
                                        className="require_info">*</span></div>
                                    <div className="inputpw input_bottom">
                                        <input
                                    ...
                                    <div className="subinfo">닉네임<span
                                        className="require_info">*</span></div>
                        ...
                        <div className="check_term_of_service">
                            {CheckImg ? <span><img src={checkbox} width="20px"
                                                   onClick={onCheckImg}/>
                            <p onClick={onTermToggle}>이용약관</p></span>
                                : <span><img src={uncheckbox} width="20px"
                                             onClick={onCheckImg}/>
